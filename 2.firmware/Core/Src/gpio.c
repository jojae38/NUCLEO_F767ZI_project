...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(BNO085_PS0_GPIO_Port, BNO085_PS0_Pin);

  /**/
  LL_GPIO_SetOutputPin(BNO085_PS1_GPIO_Port, BNO085_PS1_Pin);

  /**/
  LL_GPIO_SetOutputPin(BNO085_RST_GPIO_Port, BNO085_RST_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BNO085_PS0_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = BNO085_PS1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BNO085_PS1_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BNO085_RST_GPIO_Port, &GPIO_InitStruct);
  ...
  LL_GPIO_Init(BNO085_INT_GPIO_Port, &GPIO_InitStruct);
